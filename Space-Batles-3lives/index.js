...
var startGame = function() {
  ...
  Game.setBoard(3,new TitleScreen("Space Battles", 
...
var level1 = [
 // Start,   End, Gap,  Type,   Override
  ...
  [ 0,      5000,  3800, 'ltr',{ x: 50 } ],
  [ 7000,   13000, 2800, 'ltr' ],
  [ 15000,   21000, 1800, 'ltr' ],
  [ 23000,   33000, 800, 'ltr' ],
  [ 35000,   43000, 500, 'ltr',{ x: 20 } ],
     
    
  [ 45000,  49000, 400, 'wiggle', { x: 200 }],
  [ 50000,  56000, 400, 'circle' ],
  [ 60000,  64000, 500, 'straight', { x: 50 } ],
  [ 64200,  66000, 1500, 'straight', { x: 90 } ],
  [ 64200,  68000, 1500, 'straight', { x: 10 } ],

  [ 68000,      70000, 400, 'circle' ],
  [ 68000,      72000,  500, 'step' ],
